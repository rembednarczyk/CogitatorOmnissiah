...
export const OtherToolsCard: React.FC<OtherToolsCardProps> = ({
  ...
  const rituals: { color: RitualColor; icon: typeof Database; title: string; subtitle: string; onClick: () => void; animate?: "spin" | "pulse" }[] = [
    ...
    { color: "amber", icon: Layers, title: "Rytuał Żniw Cykli", subtitle: "Zbieranie sąsiednich tomów cyklu z Encyklopedii (cache, bez dopisywania do bazy)", onClick: handleCyclesHarvest, animate: cyclesHarvestSync.state.loading ? "spin" : undefined },
